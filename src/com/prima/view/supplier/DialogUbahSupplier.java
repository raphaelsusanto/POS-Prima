 ...
 * @author raphael
 */
public class DialogUbahSupplier extends javax.swing.JDialog {

    /** Creates new form DialogTambahBarang */
    private int id;

    public DialogUbahSupplier(java.awt.Frame parent, boolean modal, int id) {
        super(parent, modal);
        initComponents();
    ...
    private void initData() {
        ...
        jtfNama.setText(supplier.getNama());
        jtfTelp.setText(supplier.getTelp());
        jtfEmail.setText(supplier.getEmail());
        jtaAlamat.setText(supplier.getAlamat());
    }
...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    if (jtfNama.getText().trim().equals("") ) {
        JOptionPane.showMessageDialog(null, "Data supplier yang dimasukan belum lengkap");
    }  else {
        Supplier supplier = new Supplier();
        supplier.setIdSupplier(id);
        supplier.setNama(jtfNama.getText());
        supplier.setAlamat(jtaAlamat.getText());
        supplier.setTelp(jtfTelp.getText());
