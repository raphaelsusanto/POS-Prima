 ...
 * @author raphael
 */
public class DialogTambahSupplier extends javax.swing.JDialog {

    /** Creates new form DialogTambahBarang */
    public DialogTambahSupplier(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    if (jtfNama.getText().trim().equals("")) {
        ...
        new SupplierDAO().saveSupplier(supplier);
        this.setVisible(false);
    }
