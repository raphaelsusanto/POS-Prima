 ...
 * @author raphael
 */
public class DialogUbahPembeli extends javax.swing.JDialog {

    /** Creates new form DialogTambahBarang */
    private int id;

    public DialogUbahPembeli(java.awt.Frame parent, boolean modal, int id) {
        super(parent, modal);
        initComponents();
    ...
    private void initData() {
        ...
        Pembeli pembeli = dao.getPembeliById(id);
        jtfNama.setText(pembeli.getNama());
        jtfTelp.setText(pembeli.getTelp());
        jtfEmail.setText(pembeli.getEmail());
        jtaAlamat.setText(pembeli.getAlamat());
    }
...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    if (jtfNama.getText().trim().equals("") || jtfEmail.getText().trim().equals("") || jtfEmail.getText().trim().equals("") || jtaAlamat.getText().trim().equals("")) {
        JOptionPane.showMessageDialog(null, "Data pembeli yang dimasukan belum lengkap");
    } else if (!isValidEmailAddress(jtfEmail.getText())) {
        JOptionPane.showMessageDialog(null, "Email yang dimasukan tidak valid");
    } else {
        Pembeli pembeli = new Pembeli();
        pembeli.setIdPembeli(id);
        ...
        new PembeliDAO().updatePembeli(pembeli);
        this.setVisible(false);
    }
